                                        ...
                                        <div id="edit" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form id="update_form" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>ID</label>
                                                                <input type="text" id="name_u" name="editempid" value="<?php echo $_SESSION['id']; ?>" class="form-control" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Username</label>
                                                                <input type="text" id="username_u" name="editusername" value="<?php echo $_SESSION['username']; ?>" class="form-control" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>New Password</label>
                                                                <input type="password" id="password_u" name="newpassword" class="form-control" required>
                                                            </div>
                                                        </div>
                                                    ...
                                                    {
                                                        $sql = "UPDATE users u SET u.password='" . $_POST['newpassword'] . "'
                                                        WHERE u.id='" . $_SESSION['id'] . "';";
                                                        if ($conn->query($sql) === TRUE) {
                                                            echo '<script>alert("Credentials Changed Successfully!") 
                                                            window.location.href="acc_settings.php"</script>';
